...
import com.example.GuessBeerCountry.Library.Title;
...
public class Setting extends SherlockPreferenceActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Language.SetSetting(ComponentName.Setting, this.getBaseContext());
        Title.SetTitle(ComponentName.Setting, actionBar, this.getBaseContext());
    ...
    public void onResume() {
        ...
        Utility.SetTransition(this.getBaseContext(), this, com.guess.license.plate.Activity.SETTING);
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        if (key.equals(Preferences.LANGUAGE.toString())) {
            ...
            // In case the theme is changed setting the action bar for setting and main, and setting the template of main
            //Title.SetTitle(com.guess.license.plate.Activity.SETTING, getSupportActionBar(), this.getBaseContext());
    ...
    private void setSummary(SharedPreferences sharedPreferences, Preferences key) {
        ...
        String[] strTitle = Language.GetStringArray(com.guess.license.plate.Activity.SETTING_TITLE, this.getBaseContext(), language, SIZE);
        String[] strSummary = Language.GetStringArray(com.guess.license.plate.Activity.SETTING_SUMMARY, this.getBaseContext(), language, SIZE);
