...
import com.example.GuessBeerCountry.Database.Database;
import com.example.GuessBeerCountry.Database.DatabaseHelper;
import com.example.GuessBeerCountry.Database.InitialData;
    ...
    private void setDefaultValues() {
        if (databaseHelper != null) {
            ...
            if (count == 0) {
                ...
                // InsertScore
                InitialData.InsertScore(db);
                // InsertStats
                InitialData.InsertStats(db);
            }
